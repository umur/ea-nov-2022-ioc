...
public class MyInjector {
    ...
    public MyInjector()  throws NoSuchMethodException, IllegalAccessException, InvocationTargetException, InstantiationException  {
        init();
    }
    ...
    public void init() throws NoSuchMethodException, IllegalAccessException, InvocationTargetException, InstantiationException {
        ...
        configurationBuilder.setUrls(ClasspathHelper.forPackage("com.example.eanov2022ioc"));
